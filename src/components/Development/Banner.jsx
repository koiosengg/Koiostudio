...
import DesktopBackground from "../../assets/Development/Banner/Desktop Background.webp";
import MobileBackground from "../../assets/Development/Banner/Mobile Background.webp";
  ...
  return (
    <section className="home-banner" ref={bannerRef}>
      <img
        ...
        alt="Development Banner Background"
        style={{ opacity }}
