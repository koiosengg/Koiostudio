      ...
      <div className="conn-hero-grid">
        <div className="conn-hero-content">
          ...
          <p className="conn-hero-desc">
            When someone in my network asks,{" "}
            <strong>"Do you know someone great who does this?"</strong>, I want
            to be able to recommend you instantly. Share your details, services,
            and ideal clients so I can connect you with the right opportunities.
          </p>
        ...
        <div className="conn-quote-card">
          <p className="conn-quote-text">
            "The most direct path to meaningful collaboration starts with
            knowing <em>exactly</em> who you are and what you excel at."
          </p>
