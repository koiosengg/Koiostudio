...
function Testimony() {
  const slides = [
    {
      desc: "Lorem ipsum dolor sit amet consectetur. Suspendisse convallis placerat id ultrices purus suspendisse dolor quis. Vel mi ac est facilisi sem tortor massa maecenas. Dui accumsan nulla eu fames placerat id ultrices. Lorem ipsum dolor sit placerat amet consectetur.",
      personName: "Nishan Kumar",
      location: "India",
    },
    {
      desc: "Lorem ipsum dolor sit amet consectetur. Suspendisse convallis placerat id ultrices purus suspendisse dolor quis. Lorem ipsum dolor sit amet consectetur. Vel mi ac est facilisi sem tortor massa maecenas. Dui accumsan nulla eu fames placerat id ultrices.",
      personName: "Kishor Kumar",
      location: "India",
    },
    {
      desc: "Lorem ipsum dolor sit amet consectetur. Suspendisse convallis placerat id ultrices purus suspendisse dolor quis. Vel mi ac est facilisi sem tortor massa maecenas. Dui accumsan nulla eu fames placerat id ultrices. Suspendisse convallis placerat id ultrices purus suspendisse dolor quis.",
  ...
  return (
    <section className="template testimony">
      ...
      <div className="template-heading">
        <p>Our Pride</p>
        <h2>
          Our Works & <br className="desktop" /> Collaborations
        </h2>
      </div>
      <div className="home-testimony">
        <div
          className="home-testimony-slide"
          style={{
            display: "flex",
            gap: "16px",
        ...
        >
          {slides.map((slide, index) => (
            <div className="home-testimony-set white-top-border" key={index}>
              ...
              <h3>
                {slide.personName}, <span>{slide.location}</span>
              </h3>
            </div>
          ))}
        </div>
        <div className="home-testimony-controls">
          <div
            className="home-testimony-control"
            onClick={handlePrev}
            style={{
